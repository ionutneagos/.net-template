...
namespace Presentation.Controllers.v1
{
    ...
    public class SampleController : BaseController
    {
        ...
        {
            IQueryable<SampleDto> query = serviceManager.SampleService.GetAll()
        ...
        {
            Domain.Entities.Catalog.Sample result = await serviceManager.SampleService.GetByIdAsync(id);
            if (result == null)
                return NotFound();
        ...
        {
            SampleDto result = await serviceManager.SampleService.AddSampleAsync(sampleForCreationDto, cancellationToken);
